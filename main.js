var authorization = "Bearer Bearer AAAAAAAAAAAAAAAAAAAAANRILgAAAAAAnNwIzUejRCOuH5E6I8xnZz4puTs%3D1Zv7ttfk8LF81IUq16cHjhLTvJu4FA33AGWWjCpTnA"; // replace by authorization value
var ua = navigator.userAgentData.brands.map(brand => `"${brand.brand}";v="${brand.version}"`).join(', ');
var client_tid = "ehzqbdksPE3quTbJYY0wFHOjBsDaiWhkdDK6KNVEaB/ctGHBh30+4prpsEPmaSjcqIZninjN27a/KPkVuaAmQr3xNLH6eQ"; // replace by X-Client-Transaction-Id value
var client_uuid = "7faf921f-04e0-467e-9548-e5cee3ad6042"; // replace by X-Client-Uuid value
...
var username = "big_big_E" // replace with your username
